...
!!! note
    ...
    LiteLLM 連携はベータです。特に小規模なモデルプロバイダーでは問題が発生する可能性があります。問題があれば [GitHub Issues](https://github.com/openai/openai-agents-python/issues) に報告してください。迅速に修正します。
...
-   モデルに `openai/gpt-4.1`、そして OpenAI の API キー
-   モデルに `anthropic/claude-3-5-sonnet-20240620`、そして Anthropic の API キー
-   など
