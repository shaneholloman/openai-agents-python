...
키가 없다면 [이 안내](https://platform.openai.com/docs/quickstart#create-and-export-an-api-key)를 따라 OpenAI API 키를 생성하세요.
...
각 에이전트에서, 작업을 진행하기 위해 선택할 수 있는 아웃고잉 핸드오프 옵션 인벤토리를 정의할 수 있습니다.
...
입력 또는 출력에 대해 사용자 지정 가드레일을 정의할 수 있습니다.
...
핸드오프와 입력 가드레일을 사용하여 전체 워크플로를 함께 실행해 보겠습니다.
