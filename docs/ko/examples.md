...
-   **[mcp](https://github.com/openai/openai-agents-python/tree/main/examples/mcp):**
    MCP (Model Context Protocol)로 에이전트를 만드는 방법, 다음을 포함

    -   파일 시스템 code examples
    -   Git code examples
...
-   **[model_providers](https://github.com/openai/openai-agents-python/tree/main/examples/model_providers):**
    사용자 지정 공급자 및 LiteLLM 통합을 포함하여 SDK로 OpenAI 이외의 모델을 사용하는 방법 살펴보기

-   **[realtime](https://github.com/openai/openai-agents-python/tree/main/examples/realtime):**
    SDK를 사용하여 실시간 경험을 구축하는 방법을 보여주는 code examples
...
-   **[tools](https://github.com/openai/openai-agents-python/tree/main/examples/tools):**
    다음과 같은 OpenAI 호스트하는 도구를 구현하는 방법 학습
...
-   **[voice](https://github.com/openai/openai-agents-python/tree/main/examples/voice):**
    TTS 및 STT 모델을 사용한 음성 에이전트 code examples, 스트리밍 음성 code examples 포함