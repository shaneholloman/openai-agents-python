...
使用 OpenAI 的 Realtime API，实时智能体可以与用户进行语音对话。本指南将带你创建第一个实时语音智能体。

!!! warning "测试版功能"
Realtime 智能体目前为测试版。随着我们改进实现，可能会出现不兼容的变更。
...
- `silence_duration_ms`: 判断轮次结束的静音时长
