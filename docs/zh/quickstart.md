...
可以用同样方式定义其他智能体。`handoff_descriptions` 提供用于确定任务转移路由的额外上下文。
...
在每个智能体上，你可以定义一个外发的任务转移选项清单，智能体可从中选择以决定如何推进其任务。
...
让我们检查工作流是否运行，并且分诊智能体是否能在两个专家智能体之间正确路由。
...
要回顾智能体运行期间发生的事情，请前往 [OpenAI 控制台中的 Trace 查看器](https://platform.openai.com/traces)查看你的运行追踪。
